...
public class DicewareController {
  ...
  public String[] get(@RequestParam(value = LENGTH_PARAMETER, defaultValue = DEFAULT_LENGTH) int length) {
    return generator.passphrase(length);
  }

  @GetMapping(produces = MediaType.TEXT_PLAIN_VALUE)
  public String get(@RequestParam(value = LENGTH_PARAMETER, defaultValue = DEFAULT_LENGTH) int length, @RequestParam (defaultValue = " ") String delimiter) {
